...
<div class="text-center">
	<c:if test="${USER.userId == board.writer }">
		<a href="../edit/${board.boardId}?page=${param.page}" class="btn btn-dark-green">
			<i class = "fa fa-edit mr-2"></i>수정</a>
		<a href="#" id="delete-btn" class="btn btn-dark-green">
			<i class = "fa fa-trash mr-2"></i>삭제</a>
	</c:if>
...
<div class="password-panel text-center my-3" style="display:none">
	...
	<button type="button" id="delete-confirm" data-target="${board.boardId }">확인</button>
